...
<!-- Image placement: diagram 4 trụ Model Foundations, alt="Sơ đồ 4 trụ Rails Model Foundations theo Chương 6 tài liệu Rails Tutorial của Michael Hartl" -->
...
<!-- Video suggestion: Rails Migrations Explained - GoRails, url="https://www.youtube.com/watch?v=FBu6y2E0D9o" (review and embed after publish approval) -->
...
<!-- Video suggestion: Has Secure Password in Rails - Bcrypt Explained, url="https://www.youtube.com/watch?v=X_qcHoqitUs" (review and embed after publish approval) -->
...
- ActiveRecord has_secure_password - bcrypt và authenticate, neo cho H2 has_secure_password
- [[Rails Model Tests]] - mẫu setup/valid?/fixtures, neo cho H2 model tests
- Chương 6 (Modeling Users) của Michael Hartl - hub tổng hợp Hartl, neo cho H2 mở đầu và kết luận
- kiến trúc Ruby on Rails MVC - bối cảnh Model trong MVC, đặt ở H2 vì sao foundations quan trọng
