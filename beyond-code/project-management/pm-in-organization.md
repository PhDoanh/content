...
- **Phân tích hệ thống**: Chia hệ thống thành các phần nhỏ theo nguyên tắc _“chia để trị”_. Xác định phạm vi, đánh giá vấn đề, tìm cơ hội – thách thức, rồi đề xuất giải pháp tối ưu.
...
- Có **hai dòng báo cáo**:
    1. Cho quản lý chức năng (Functional Manager).
    2. Cho quản lý dự án (Project Manager).
...
> [!question]- Nhà quản lý dự án cần làm gì?
