...
Trong sự phức tạp của tiếng Nhật, những thứ ở trên mới chỉ là *"phần nổi của tảng băng chìm"*, nhưng khi được hỏi vì sao tiếng nhật khó thì phần nổi đó lại là câu trả lời của đại đa số người học. Nghiêm túc mà nói, kể cả những người có kinh nghiệm đầy mình (không phải mình 😅) cũng bối rối và khó hiểu về cách dùng **dù cho họ đang áp dụng nó**! Với cách học truyền thống trước kia, mình còn thấy khó hơn gấp nhiều lần nhưng mình nhận ra bản thân sẽ tiếp thu nhanh hơn nếu mọi thứ xung quanh mình **toàn là tiếng Nhật**! Đó chính là hiệu quả của phương pháp **Immersion** (hòa nhập). Và bài viết này ra đời với mục đích kiểm chứng phương pháp và vạch ra lộ trình học cho mọi người và người đang theo học như mình 😗 

**Tóm tắt lộ trình**:
%% TODO: convert to mermaid diagram %%

![[roadmap.png|center]]

**Hòa nhập** sẽ là bước mất nhiều thời gian của bạn nhất nhưng cũng là bước thú vị nhất vì bạn sẽ được va chạm với những nội dung tiếng Nhật trong thực tế bao gồm: truyện tranh (manga), tiểu thuyết thuần chữ (light novel), tiểu thuyết có ảnh (visual novel ↔ game), hoạt hình (anime), ... Giờ thì hãy cùng mình khám phá từng bước một nhé 👇

## Học bảng chữ Kana

![[kana.png|center ws-med]]

Xét về bản chất, tiếng Nhật có 3 hệ thống chữ viết:
- **Hiragana và katakana**: tương tự như bảng chữ cái tiếng Anh, nhưng chỉ chứa các nguyên âm u, e, o, a, i (uể oải) và các kết hợp của chúng với tiền tố k-, s-, m-, ... Do đó có âm điệu cho cả chữ có 2-3 ký tự. Ví dụ: い (i), き (ki), し (shi), ... 
- **Kanji**: là thứ mà hầu hết mọi người nghĩ tới khi bắt đầu học tiếng Nhật, được dùng để mô tả các danh từ, động từ, tính từ ... Nói cách khác, nó đại diện cho một từ/cụm từ hoàn chỉnh.

Để hỗ trợ người học nước ngoài và cách phát âm của một Kanji có nhiều cách đọc, một số **công cụ** sau ra đời:
- **Romaji**: bảng chữ cái tiếng Anh (các chữ cái La tinh - Roman như tên gọi của nó), được dùng kết hợp trong quá trình học 3 hệ thống trên để hỗ trợ người học tiếp cận dễ dàng hơn.
- **Furigana/Ruby**: phương thức trình bày cho phép những ký tự nhỏ được đặt phía trên (khi viết ngang) hoặc bên phải (khi viết dọc) của một chữ Hán (Kanji) để chỉ dẫn cách phát âm của chữ đó.

Có rất nhiều cách học bảng chữ cái, nhưng triết lý "học có tương tác" từ trang web [này](https://vedxyz.github.io/kana/) là tất cả những gì bạn cần!

## Thiết lập các công cụ học
![[study-tools.png|center ws-med]]

Phần này sẽ ngốn đâu đó vài giờ đồng hồ của bạn vì nó liên quan đến các vấn đề về kĩ thuật. Nhưng yên tâm là hướng dẫn thiết lập rất dễ hiểu và nếu có vướng mắc, mình luôn ở đây để <a href="#footer">hỗ trợ</a> bạn!
...
| **Trang web**                   |                                                                                                                                                                                                                                                                                   [The Kanji Map](https://thekanjimap.com/) - Tìm hiểu các thành phần kanji<br><br>                                                                                                                                                                                                                                                                                    | [[jpg-notebook\|Sổ tay của mình]]<br>[IMABI](https://www.imabi.org/) **(khuyên dùng)**<br>[Tae Kim](https://guidetojapanese.org/learn/category/grammar-guide/basic-grammar/)<br>[Sakubi](https://sakubi.neocities.org/)<br> |
