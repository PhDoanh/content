---
stage: Review
title: "Ringurooma Koe API: REST API for Japanese Voice Services"
description: 
permalink: 
lang: en
draft: false
...
> Orginal name: Ring Rome Voice API
...
- **Feedback**: Version and status information
- **Example response**:
```json
{
...
PORT=3000 (optional)
```
1. Run the service: `node server.js` or `npm start`
